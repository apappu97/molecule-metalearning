...
gpu=$9 # gpu number to run on

test_folds_to_test=${10} # number of test folds; probably use 3
val_folds_per_test=${11} # number of val folds; prob use 1
time_split=${12} # true
run_features=${13} # true
num_epochs=${14} # 300
